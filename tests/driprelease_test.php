...
class driprelease_test extends \advanced_testcase {
    ...
    public function test_get_table_data() {
        ...
        $this->assertEquals("1672502400", $row1['calculatedavailability']['start']);
        $this->assertEquals("1672502400", $row1['calculatedavailability']['end']);

        $this->assertEquals("1672588800", $row2['calculatedavailability']['start']);
        $this->assertEquals("1672588800", $row2['calculatedavailability']['end']);
    }
    /**
