...
Feature: Drip release modifies activity availability
  ...
  Background:
    ...
    And the following "activities" exist:
        ...
        | quiz     | Quiz 1 | C1     | Loren sum dolor sit mate, sol um cu quo, est ea accustom investiture. Nahum slum vociferous e viz, ad discern inimical descriptionend. |
        | quiz     | Quiz 2 | C1     |                                                                                                                                        |
        | quiz     | Quiz 3 | C1     |                                                                                                                                        |
        | quiz     | Quiz 4 | C1     |                                                                                                                                        |
        | quiz     | Quiz 5 | C1     |                                                                                                                                        |
  ...
  Scenario: Select/deselect activities to set their availability
    ...
    And I click on "Quiz 1" "link" in the "Quiz 1" "table_row"
    And I should see "Preview quiz"
    And I am on "Course 1" course homepage with editing mode on
    When I open "Quiz 1" actions menu
    ...
    When I open "Quiz 2" actions menu
    And I click on "Edit settings" "link" in the "Quiz 2" activity
    And I expand all fieldsets
    ...
    Then I should see "3" in the "Quiz 1" "table_row"
    ...
    And I set the field "repeatgroup[repeatcount]" to ""
    And I should see "You must supply a value here"
    And I set the field "repeatgroup[repeatcount]" to "1"
    ...
    And I click on "select" "checkbox" in the "Quiz 1" "table_row"
    ...
    Then I should see "01 Jan 2017" in the "Quiz 1" "table_row"
    # Confirm only the row with a selected checkbox have been updated
    Then I should not see "01 Jan 2017" in the "Quiz 2" "table_row"
    Then I should see "08 Jan 2017" in the "Quiz 1" "table_row"
    ...
    Then I should see "01 Jan 2017" in the "Quiz 1" "table_row"
    # Confirm only the row with a selected checkbox have been updated
    Then I should not see "08 Jan 2017" in the "Quiz 2" "table_row"
    Then I should see "08 Jan 2017" in the "Quiz 1" "table_row"
    # Now select the second module/quiz
    And I click on "select" "checkbox" in the "Quiz 2" "table_row"
    And I press "Save and display"
    # Check the table and modules availability has been updated
    Then I should see "01 Jan 2017" in the "Quiz 1" "table_row"
    Then I should see "08 Jan 2017" in the "Quiz 2" "table_row"
    # Deselect rows for Quiz 1 and 2
    And I click on "select" "checkbox" in the "Quiz 1" "table_row"
    And I click on "select" "checkbox" in the "Quiz 2" "table_row"
    # Select quiz 3
    ...
    Then I should see "01 Feb 2017" in the "Quiz 3" "table_row"
    # This will toggle all rows to checked
    And I click on "selectall" "checkbox"
    And I press "Save and display"
    Then I should see "01 Feb 2017" in the "Quiz 5" "table_row"
    # The next session
    Then I should see "08 Feb 2017" in the "Quiz 6" "table_row"
