@tool @tool_driprelease @tool_driprelease_togglesession
Feature: Toggle all items in a session
  ...
  Scenario: Select/deselect activities to set their availability
    ...
    And I click on "Reset unselected" "checkbox"
    And I click on "#sessionid_1" "css_element"
    And I press "Save and display"
    Then I should not see "Sun 1 Jan 2017" in the "Quiz1" "table_row"
    Then I should see "Sun 1 Jan 2017" in the "Quiz3" "table_row"
